...
def main():
    ...
    parser.add_argument('--my-playlists', action='store_true', help='Clear and insert data into Playlists table')
    parser.add_argument('--master-tracks', action='store_true', help='Clear and insert data into Tracks table')
